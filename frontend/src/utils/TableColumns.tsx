...
const monthToReadable = (inputString: string) => {
  ...
  let date = new Date(
    parseInt(inputString.substring(0, 4)),
    parseInt(inputString.substring(4, 6)) - 1
  );
...
export const costByMonthColumns: MRT_ColumnDef<CostByMonth>[] = [
  {
    ...
    header: "Month",
    size: 100,
    Cell: ({ cell }) => <Text>{monthToReadable(cell.getValue<string>())}</Text>,
  },
  {
    accessorKey: "totalCost",
    header: "Cost",
    size: 80,
    Cell: ({ cell }) => <Text>{numToCost(cell.getValue<number>())}</Text>,
  },
  {
...
export const allDataColumns: MRT_ColumnDef<AllData>[] = [
  ...
  },
  {
    ...
    Cell: ({ cell }) => <Text>{dateToReadable(cell.getValue<string>())}</Text>,
  },
  {
...
export const bigQueryJobsListColumns: MRT_ColumnDef<BigQueryJob>[] = [
  ...
  },
  {
    ...
    size: 80,
    Cell: ({ cell }) => (
      <Badge color={statusToColor(cell.getValue<string>())}>
  ...
  },
  {
    ...
    Cell: ({ cell }) => (
      <Text>{dateToReadableMs(cell.getValue<string>())}</Text>
    ),
  },
  {
